...
@section('content')
 ...
 <div class="container">
    <div class="bread-crumb flex-w p-t-30">
        <a href="{{ route('shopPage') }}" class="mtext-106 cl8 hov-cl1 trans-04">
            خانه
                ...
                <div class="p-l-25 p-l-0-lg">
                    <div class="wrap-slick3 flex-sb flex-w">
                        ...
                        <div class="slick3 gallery-lb">
                            <div class="item-slick3" data-thumb="/uploads/{{ $product['thumbnail_url'] }}">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="/uploads/{{ $product['thumbnail_url'] }}" alt="IMG-PRODUCT">

                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/uploads/{{ $product['thumbnail_url'] }}">
                    ...
                    <div class="p-t-33">
                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            <div class="flex-w flex-m respon6-next">
                                <a href="{{ route('cart.add' , $product->id) }}" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">افزودن به سبد خرید</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="{{ route('product.single' , $product['id'] ) }}" class="mtext-106 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                    {{ $product['title']  }}
                                </a>
